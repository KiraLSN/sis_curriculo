...
//=============================================================================================================================== 
   ...
   case 'buscar_curriculo':
      ...
      if ($nome == ''):
         ...
         $nome = "nome like '%" . Check::Limitador($nome, '1') . "%' or  '%" . $nome . "%'  and";
      endif;

      if ($curso == ''):
         $curso = '';
      else:
         $curso = "curso = '" . $curso . "'   and";
      endif;

      if ($instituicao == ''):
         $instituicao = '';
      else:
         $instituicao = "instituicao = '" . $instituicao . "'   and";
      endif;
      ...
      elseif($coeficiente == '1'):
         $coeficiente = "coeficiente BETWEEN 0 and 5.0 and";
      elseif($coeficiente == '2'):
         $coeficiente = "coeficiente BETWEEN 5.1 and 6.9 and";
      elseif($coeficiente == '3'):
         $coeficiente = "coeficiente BETWEEN 7.0 and 8.0 and";
      elseif($coeficiente == '4'):
         $coeficiente = "coeficiente BETWEEN 8.1 and 9.0 and";
      elseif($coeficiente == '5'):
         $coeficiente = "coeficiente BETWEEN 9.1 and 9.9 and";
      endif;
      
      if ($area == ''):
          $area = '';
      else:
         $area = "atuacao.id_curriculo = '" . $area . "'   and";
      endif;
      
     
      $read = new Read;
      $read->FullRead("
         select *, atuacao.nome AS nome_atuacao, atuacao.id AS id_atuacao, curriculo.nome AS nome, curriculo.id AS id from 
         curriculo 
         ...
         WHERE 
             ...
             " . $coeficiente . " 
             " . $area . " 
             status = '1' GROUP BY curriculo.id"
      );
